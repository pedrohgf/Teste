                    ...
                    <tbody>
                      ...
                      for($i=0; $i<count($listaUsuarios); $i++){
                        ...
                        if($usuario['ID_STATUS']==1){
                          $usuario['STATUS']="Regular";
                        }
                        else{
                          $usuario['STATUS']="Matrícula Trancada";
                        }
...
function getUsersList(){
  $requestUsersList = file_get_contents('http://35.199.101.182/api/usuarios');
  $usersList = json_decode($requestUsersList, true);
  return $usersList;
}
?>
