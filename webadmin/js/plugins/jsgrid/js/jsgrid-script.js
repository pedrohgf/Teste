$(function() {
            ...
            $("#jsGrid-custom").jsGrid({
                ...
                controller: db,
                fields: [
				    { name: "ID_Usuário", type: "number", width: 150 },
                    { name: "Nome", type: "text", width: 150 },
                    { name: "Matrícula", type: "number", width: 150 },
					{ name: "CPF", type: "number", width: 150 },
                    { name: "Email", type: "text", width: 200 },
					{ name: "Grupo", type: "number", width: 150 },
					{ name: "Status", type: "select", items: db.statuss, valueField: "Id", textField: "Name" },
