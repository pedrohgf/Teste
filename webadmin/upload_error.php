      ...
      <section id="content">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li><a href="propaganda.php">Inserir Propaganda</a></li>
                    <li class="active">Upload de Propaganda</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Falha no Upload</p>
            <div class="divider "></div>
			 <h5>Não foi possível realizar o upload da imagem</h5>
			<br><br><br>
